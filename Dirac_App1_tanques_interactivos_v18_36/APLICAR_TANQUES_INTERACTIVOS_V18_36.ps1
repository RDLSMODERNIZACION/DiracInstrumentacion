...
Write-Host "Aplicando V18.36 - tanques interactivos..." -ForegroundColor Cyan
...
if ([regex]::IsMatch($widget, $operationTankPattern)) {
    $widget = [regex]::Replace($widget, $operationTankPattern, $newOperationTank, 1)
} else {
...
Write-Host ""
Write-Host "V18.36 aplicado correctamente." -ForegroundColor Green
Write-Host ""
