...
export default function PumpNodeView({
  ...
  // Por ahora todo queda en MANUAL.
  // Después se puede reemplazar por el dato real del PLC.
  const controlMode = "M";
  ...
  if (orientation === "horizontal") {
    return (
      ...
      >
        ...
        {/* La traslación queda fija; solo gira el grupo interior */}
